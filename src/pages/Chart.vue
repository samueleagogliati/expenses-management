<template>
    <main class="container mb-5">
        ...
        <div id="container-chart" style="height: ">
            <div class="row w-100 mt-1">
                ...
                <div class="col">
                    <apexchart v-if="loading" type="pie" :options="chartOptions" :series="series" width="600" height="600"></apexchart>
                </div>
            </div>
        </div>
    </main>
  ...
  export default defineComponent({
    ...
    data() {
      return {
        ...
        chartOptions: {
          ...
          labels: [], 
          colors: ['#007bff', '#6610f2', '#6f42c1', '#dc3545', '#fd7e14', '#ffc107', '#28a745', '#20c997'],
    ...
    methods: {
        ...
        async loadData(){
            this.loading = false
            let resp = await axios.post("http://locahost:5000/expenses_by_category", {month: this.filters.month, year: this.filters.year, userId: this.user.id})
            this.data = resp.data
