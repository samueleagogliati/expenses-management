        ...
        <tbody>
          <tr v-for="(expense, index) in expenses" :key="index">
            <td class="align-middle">
              <input v-if="expense.editMode" v-model="expense.category" class="form-control">
              <span v-else>{{ expense.category }}</span>
            </td>
            <td class="align-middle">
              <input v-if="expense.editMode" v-model="expense.description" class="form-control">
              <span v-else>{{ expense.description }}</span>
            </td>
            <td class="align-middle">
              <input v-if="expense.editMode" v-model="expense.price" class="form-control">
              <span v-else>{{ formatPrice(expense.price) }}</span>
            </td>
            <td class="align-middle">
              <button class="btn" @click="deleteExpense(expense.id)" type="button">
