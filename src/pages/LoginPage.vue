<template>
  <div class="login-container mt-5">
    <form id="login-form" novalidate="novalidate">
      ...
      <error-message class="mt-3" v-if="errorMessage" :message="errorMessage" @alertClosed="resetErrorMessage"></error-message>
    ...
    methods: {
      async login() {
        try {
          ...
          let resp = await axios.post('http://localhost:5000/login', params)
